...
class FreeTypeFontTest(unittest.TestCase):
    ...
    def test_freetype_Font_get_rect(self):
        ...
        self.assertTrue(rect_default.size > rect_default.size)
        ...
        self.assertEqual(rect_x.size, rect24.size)
        self.assertEqual(rect_x.size, rect12.size)
        rect_y = font.get_rect("A", size=(12.0, 24.0))
        self.assertEqual(rect_y.size, rect12.size)
        self.assertEqual(rect_y.size, rect24.size)

    def test_freetype_Font_height(self):

        f = self._TEST_FONTS["sans"]
        self.assertEqual(f.size, 2355)

        f = self._TEST_FONTS["fixed"]
        self.assertEqual(f.size, 1100)
    ...
    def test_freetype_Font_render_to(self):
        ...
        self.assertEqual(rrect.size, font.get_sized_height(24))
    ...
    def test_freetype_Font_render(self):
        ...
        self.assertEqual(r.size, font.get_sized_height(24))
    ...
    def test_freetype_Font_render_to_mono(self):
        ...
        try:
            ...
            for i, surf in enumerate(surfaces):
                ...
                bottomright = rrect.size - 1, rrect.size - 1
                self.assertEqual(
    ...
    def test_undefined_character_code(self):
        ...
        self.assertTrue(size1.size > size0.size)
    ...
    def test_issue_243(self):
        ...
        self.assertEqual(r2.size, 2 * r1.size)
